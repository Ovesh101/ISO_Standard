  ...
  return (
    <div className="mt-2 shadow-md rounded-[15px]">
      ...
      <div className="px-6 lg:px-[130px] pt-10 lg:pt-[130px] text-center lg:text-left">
        {/* Title */}
        <h2 className="text-[36px] lg:text-[60px] font-semibold text-title">
          Our Accreditations
        </h2>

        {/* Description */}
        <p className="text-[18px] lg:text-[24px] mt-5 lg:mt-[35px] leading-[24px] text-custom_grey">
      ...
      <div className="flex flex-wrap justify-center lg:justify-start gap-6 px-6 lg:px-[130px] pt-10 lg:pt-[130px]">
