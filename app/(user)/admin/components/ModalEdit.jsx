          ...
          <div className="mb-4">
            ...
            {imagePreview && (
              <img
                src={imagePreview}
                alt="Preview"
                className="mt-3 w-24 h-auto rounded-lg"
              />
            )}
            {imageError && (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end mt-4">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 mr-2"
            >
              Close
            </button>
            <button
